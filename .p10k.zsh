# Generated by Powerlevel10k configuration wizard on 2022-08-05 at 15:02 CEST.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=6 #232
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=8 #7
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_MAX_LENGTH=25% #default was 80
